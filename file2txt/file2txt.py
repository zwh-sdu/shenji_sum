...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_dir", default="./data/file", type=str, help="文件读取目录")
    parser.add_argument("--result_file_dir", default="./data/txt", type=str, help="解析后txt输出目录")
    args = parser.parse_args()

    # # doc转docx
    # file_dir = r'F:\宝贝派的活儿\知识图谱\file2txt\files' # 绝对路径，不能是相对路径，否则dox转docx会找不到文件
    ...
    for file in all_files:
        if file[-4:] == '.pdf':
            ...
            result_file_path = result_file_path.replace(file_dir, result_file_dir)
